...
- Do not use this firmware to control devices; it does not implement actuator logic.
- Comply with local laws and regulations when deploying sensors and networking equipment.
